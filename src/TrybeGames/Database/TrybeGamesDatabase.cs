...
public class TrybeGamesDatabase
{
    ...
    {
        // implementar
        return Games.FindAll(game => game.DeveloperStudio == gameStudio.Id);
    }
    ...
    {
        // Implementar
        return Games.FindAll(game => player.GamesOwned.Contains(game.Id));
    }
    ...
    {
        // Implementar
        return Games.FindAll(game => playerEntry.GamesOwned.Contains(game.Id));
    }
